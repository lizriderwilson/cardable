...
game = Card.create(name: "Empty the litter box", description: "pixel art jrpg", column: to_do)
game = Card.create(name: "Take out the trash", description: "pixel art jrpg", column: to_do)
